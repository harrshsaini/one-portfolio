    ...
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black to-gray-800 via-black'>
         <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                ...
                I am a Computer Engineering graduate from GEU, Dehradun. Passionate about technology-driven transformations, I excel in C++ for Data Structures, ReactJS/NodeJS for Web Development, and Python for Machine Learning.
                </p>
                <div>
